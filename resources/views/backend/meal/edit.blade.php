                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    <select name="day" id="day" class="form-control" required>
                                                        <option value="monday" @if($meal->day == 'monday') selected @endif>Monday</option>
                                                        <option value="tuesday" @if($meal->day == 'tuesday') selected @endif>Tuesday</option>
                                                        <option value="wednesday" @if($meal->day == 'wednesday') selected @endif>Wednesday</option>
                                                        <option value="thursday" @if($meal->day == 'thursday') selected @endif>Thursday</option>
                                                        <option value="friday" @if($meal->day == 'friday') selected @endif>Friday</option>
                                                        <option value="saturday" @if($meal->day == 'saturday') selected @endif>Saturday</option>
                                                        <option value="sunday" @if($meal->day == 'sunday') selected @endif>Sunday</option>
                                                    </select>
                                                </div>
                                                <div class="col-md-4">
                                                    <label class="">Meal Time</label>
                                                    <select name="period" id="period" class="form-control" required>
                                                        <option value="breakfast" @if($meal->period == 'breakfast') selected @endif>Breakfast</option>
                                                        <option value="lunch" @if($meal->period == 'lunch') selected @endif>Lunch</option>
                                                        <option value="dinner" @if($meal->period == 'dinner') selected @endif>Dinner</option>
                                                        <option value="dessert" @if($meal->period == 'dessert') selected @endif>Dessert</option>
                                                    </select>
                                                </div>
