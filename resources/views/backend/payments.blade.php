                            ...
                            <table id="datatables" class="table table-hover " cellspacing="0" width="100%" style="width:100%">
                                ...
                                <tbody>
                                    @foreach ($payments as $payment)
                                        <tr @if($payment->status) class="odds" @endif>
                                            <td>
                                            ...
                                            <td>
                                                <div class="d-flex">
                                                    ...
                                                    @endif
                                                    <button type="button" data-toggle="modal" data-target="#delete-payment{{$payment->id}}" class="btn btn-danger btn-outline btn-sm rounded" rel="tooltip" title="delete payment" data-placement="left">
                                                        <span class="btn-label">
                                                            <i class="fa fa-trash"></i>
                                                        </span>
                                                    </button>
                                                    <div class="modal fade modal-mini modal-primary" id="delete-payment{{$payment->id}}" tabindex="-1" role="dialog" aria-labelledby="delete-payment{{$payment->id}}" aria-hidden="true">
                                                        <div class="modal-dialog">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-footer">
                                                                    <form class="d-inline" action="{{route('admin.payment.delete',$payment)}}" method="POST">@csrf
