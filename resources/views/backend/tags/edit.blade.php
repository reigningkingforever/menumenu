        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-5">
                    <div class="card">
                        <div class="card-body">
                            <form method="post" action="{{route('admin.tag.update',$tag)}}" enctype="multipart/form-data"> @csrf
                                <fieldset>
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <div class="form-group">                                               
                                                ...
                                                <select name="type" id="type" class="form-control">
                                                    <option @if ($tag->type == 'category') selected @endif>Category</option>
                                                    <option @if ($tag->type == 'period') selected @endif>Period</option>
                                                    <option value="size" @if ($tag->type == 'size') selected @endif>Size</option>
                                                    <option @if ($tag->type == 'day') selected @endif>Day</option>
                                                    <option @if ($tag->type == 'origin') selected @endif>Origin</option>
                                                    <option @if ($tag->type == 'diet') selected @endif>Diet</option>  
                                                    <option @if ($tag->type == 'other') selected @endif>Other</option>  
                                                </select>
                                            </div>
                                            <div class="form-group">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <div class="form-check">
                                                            <label class="form-check-label">
                                                                <input class="form-check-input" name="is_meal" type="checkbox" @if ($tag->is_meal) checked @endif value="1">
                                                        ...
                                                        <div class="form-check">
                                                            <label class="form-check-label">
                                                                <input class="form-check-input" name="is_post" type="checkbox" @if ($tag->is_post) checked @endif value="1">
                                                                <span class="form-check-sign"></span>
                                                                Use For Post
                                                            </label>
                                                        </div>
                                                        ...
                                                        <div class="form-check form-check-radio">
                                                            <label class="form-check-label">
                                                                <input class="form-check-input" type="radio" name="status" @if ($tag->status) checked @endif id="exampleRadios1" value="1">
                                                                <span class="form-check-sign"></span>
                                                                Active
                                                            </label>
                                                        </div>
                                                        <div class="form-check form-check-radio">
                                                            <label class="form-check-label">
                                                                <input class="form-check-input" type="radio" name="status" @if (!$tag->status) checked @endif id="exampleRadios2" value="0" checked="">
                                                                <span class="form-check-sign"></span>
                                                                Inactive
                                                            </label>
                                                        </div>
